...
public class RelaeseFilmAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<RelaeseBean.ResultBean> list;
    private Context context;

    public RelaeseFilmAdapter(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final RelaeseBean.ResultBean resultBean = list.get(position);
