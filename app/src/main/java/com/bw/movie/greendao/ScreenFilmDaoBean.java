...
@Entity
public class ScreenFilmDaoBean {
    String followMovie;
    ...
    @Generated(hash = 1508674917)
    public ScreenFilmDaoBean(String followMovie, int id, String imageUrl,
    ...
    @Generated(hash = 1746597823)
    public ScreenFilmDaoBean() {
    }
}
