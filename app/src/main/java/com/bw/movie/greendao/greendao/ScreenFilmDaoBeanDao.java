...
public class ScreenFilmDaoBeanDao extends AbstractDao<ScreenFilmDaoBean, Integer> {
    ...
    /**
     * Properties of entity ScreenFilmDaoBean.<br/>
    ...
    public ScreenFilmDaoBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ScreenFilmDaoBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SCREEN_FILM_DAO_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ScreenFilmDaoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ScreenFilmDaoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public boolean hasKey(ScreenFilmDaoBean entity) {
